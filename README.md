# MA in Computational Social Sciences | Koç University Graduate Student
I recently started my MA in Computational Social Sciences at Koç University, where I explore the intersection of data, technology, and human behavior. My background in Economics from Boğaziçi University has shaped my interest in quantitative social research, and I’m now focusing on applying computational methods to analyze complex social phenomena. I’m passionate about leveraging data analytics and machine learning to gain insights into social and economic systems. I work with Python, R, and SQL to process complex datasets, automate workflows, and develop data-driven solutions. My recent projects focus on predictive modeling, text analysis, and data visualization. Please view my [CV](https://drive.google.com/file/d/11pX4P6Op__JnmsV_60KMBIgX7q5Xdljm/view?usp=sharing), check out my projects, and feel free to connect with me at [s.nurgkce@gmail.com](mailto:s.nurgkce@gmail.com)! 
